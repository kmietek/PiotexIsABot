...
namespace Factories.Facebook
{
    public class FacebookManager
    {
        ...
        public void StartProcesses(object sender, EventArgs e)
        {
            ...
            foreach (var enumPage in Helpers.EnumHelpers.GetValues<Enums.EFacebookEnum>())
            {
                Factories.Facebook.Factory.FacebookFactory.GetWebBrowserPage(enumPage).Navigate(String.Format("https://www.facebook.com/{0}/{1}", id, enumPage.ToString().ToLower()));
            }
        }
